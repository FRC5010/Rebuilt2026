...
{
    @Test void testComputeFeedforwardCoefficientsWithAcceleration()
    {
        double kS = 0.2;
        double kV = 1.5;
        double kA = 0.3;
        ...
        double[] coefficients = SystemIdentification.computeFeedforwardCoefficients(
    ...
    @Test void testComputeFeedforwardCoefficientsWithoutAccelerationData()
    {
        double kS = 0.1;
        double kV = 2.0;
        double dt = 0.02;
        ...
        double[] coefficients = SystemIdentification.computeFeedforwardCoefficients(
            velocitySamples, voltageSamples, null);
