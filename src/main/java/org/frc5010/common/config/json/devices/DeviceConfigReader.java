...
public class DeviceConfigReader
{
        ...
        throws StreamReadException, DatabindException, IOException
    {
        switch (key)
        {
            ...
            case "velocity_motor":
                ...
                system.addDevice(motorConfigurationJson.name,
                                 motorConfigurationJson.configure(system));
                break;
            case "yams_elevator":
                ...
                system.addDevice(yamsElevatorConfigurationJson.motorSetup.name,
            ...
            case "yams_arm":
                ...
                system.addDevice(yamsArmConfigurationJson.motorSetup.name,
                                 yamsArmConfigurationJson.configure(system));
                break;
            case "yams_turret":
                ...
                system.addDevice(yamsTurretConfigurationJson.motorSetup.name,
            ...
            case "yams_shooter":
                ...
                system.addDevice(yamsShooterConfigurationJson.motorSetup.name,
     ...
     */
    public static Optional<SmartMotorController> getSmartMotor(String controller,
                                                               String type,
                                                               int id,
                                                               ...
                                                               String canbus)
    {
        ...
        motor = SmartMotorFactory.create(((GenericMotorController) motorController).getMotor(),
                                         motorSim, config);
        return motor;
    }
        ...
        switch (controller.toLowerCase())
        {
            ...
            case "sparkmax":
                ...
                return ReflectionsManager.<GenericRevBrushlessMotor>create(
                    vendorType, "org.frc5010.common.motors.hardware.GenericRevBrushlessMotor",
                    new Class[] {int.class, boolean.class}, new Object[] {id, true});
            case "sparkflex":
                vendorType = VENDOR.REV;
                return ReflectionsManager.<GenericRevBrushlessMotor>create(
                    vendorType, "org.frc5010.common.motors.hardware.GenericRevBrushlessMotor",
                    new Class[] {int.class, boolean.class}, new Object[] {id, false});
            case "talonfx":
                vendorType = VENDOR.PHOENIX5;
                return ReflectionsManager.<SmartMotorController>create(
                    vendorType, "org.frc5010.common.motors.hardware.GenericTalonFXMotor",
                    new Class[] {int.class, String.class}, new Object[] {id, canbus});
            case "talonfxs":
                vendorType = VENDOR.PHOENIX6;
                return ReflectionsManager.<SmartMotorController>create(
                    vendorType, "org.frc5010.common.motors.hardware.GenericTalonFXSMotor",
                    new Class[] {int.class, String.class}, new Object[] {id, canbus});
            case "nova":
            case "thrifty":
            case "thrifty_nova":
            case "thriftynova":
                ...
                return ReflectionsManager.<SmartMotorController>create(
                    vendorType, "org.frc5010.common.motors.hardware.GenericThriftyNovaMotor",
