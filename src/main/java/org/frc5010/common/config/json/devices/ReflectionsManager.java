...
public class ReflectionsManager
{
    ...
    public enum SparkBaseType { SPARK_MAX, SPARK_FLEX }
    ...
    public static <T> T
    create(VENDOR v, String className, Class<?>[] parameterTypes, Object[] parameters)
    {
        ...
        try
        {
            ...
            Object vendorObj =
                wrapper.getDeclaredConstructor(parameterTypes).newInstance(parameters);
            return (T) vendorObj;
        }
        catch (Exception e)
        {
