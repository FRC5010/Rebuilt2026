...
public class YamsArmConfigurationJson implements DeviceConfiguration
{
     ...
     */
    @Override public Arm configure(SubsystemBase deviceHandler)
    {
        SmartMotorControllerConfig motorConfig =
            new SmartMotorControllerConfig(deviceHandler)
                ...
                .withFeedforward(
                    new ArmFeedforward(motorSystemId.feedForward.s, motorSystemId.feedForward.g,
                                       motorSystemId.feedForward.v, motorSystemId.feedForward.a))
                .withSimFeedforward(
                    new ArmFeedforward(simSystemId.feedForward.s, simSystemId.feedForward.g,
        ...
        {
            throw new RuntimeException("Smart motor configuration issue. ID: " + motorSetup.canId
                                       + " Controller: " + motorSetup.controllerType
                                       + " Motor: " + motorSetup.motorType);
        }
