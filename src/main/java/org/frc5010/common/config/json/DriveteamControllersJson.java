...
public class DriveteamControllersJson
{
     ...
     */
    public void createControllers(GenericRobot robot,
                                  Map<String, DriveteamControllerConfiguration> map)
    {
        map.keySet().forEach(it -> { robot.addController(it, map.get(it).configureController()); });
    }
        ...
        throws IOException, StreamReadException, DatabindException
    {
        ...
        for (int i = 0; i < controllers.length; i++)
        {
            ...
            DriveteamControllerConfiguration controllerConfig =
                new DriveteamControllerConfiguration();
