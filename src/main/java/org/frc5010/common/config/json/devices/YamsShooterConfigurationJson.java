...
public class YamsShooterConfigurationJson implements DeviceConfiguration
{
     ...
     */
    @Override public FlyWheel configure(SubsystemBase deviceHandler)
    {
        SmartMotorControllerConfig motorConfig =
            new SmartMotorControllerConfig(deviceHandler)
                .withFeedforward(new SimpleMotorFeedforward(motorSystemId.feedForward.s,
                                                            motorSystemId.feedForward.v,
                                                            motorSystemId.feedForward.a))
                .withSimFeedforward(new SimpleMotorFeedforward(simSystemId.feedForward.s,
        ...
        {
            throw new RuntimeException("Smart motor not found. ID: " + motorSetup.canId
