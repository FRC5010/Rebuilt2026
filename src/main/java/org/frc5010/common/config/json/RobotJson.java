...
public class RobotJson
{
    ...
    public void configureRobot(GenericRobot robot, File directory) throws IOException
    {
        ...
        drivetrainConstants.setkTeleDriveMaxAngularSpeedRadiansPerSecond(
            userModeJson.maxAngularSpeed);
        drivetrainConstants.setkTeleDriveMaxAccelerationUnitsPerSecond(
            userModeJson.maxAccelleration);
