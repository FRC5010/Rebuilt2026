...
public class AprilTags
{
     ...
     *
     * <p>This enum defines the ID, position, and orientation of AprilTags on a custom practice
     * field layout. Each constant represents one AprilTag with its coordinates (x, y, z in meters)
     * and rotation angles.
     *
    ...
    public static enum AprilTag5010 {
        ...
        private AprilTag5010(String fieldDescriptor,
                             double xPos,
                             double yPos,
                             double zPos,
                             double pitch,
    ...
    static
    {
        try
        {
            ...
            aprilTagRoomLayout = new AprilTagFieldLayout(aprilTagPoses, Units.feetToMeters(30),
