...
public class LimelightHelpers
{
    ...
    public static class RawDetection
    {
        ...
        public RawDetection(int classId,
                            double txnc,
                            double tync,
                            double ta,
                            double corner0_X,
    ...
    public static RawDetection[] getRawDetections(String limelightName)
    {
        ...
        for (int i = 0; i < numDetections; i++)
        {
            ...
            rawDetections[i] =
                new RawDetection(classId, txnc, tync, ta, corner0_X, corner0_Y, corner1_X,
     ...
     */
    public static void setCropWindow(String limelightName,
                                     double cropXMin,
                                     double cropXMax,
                                     double cropYMin,
                                     double cropYMax)
    ...
    public static void setFiducial3DOffset(String limelightName,
                                           double offsetX,
                                           double offsetY,
                                           double offsetZ)
    {
     ...
     */
    public static void SetRobotOrientation(String limelightName,
                                           double yaw,
                                           double yawRate,
                                           double pitch,
                                           double pitchRate,
