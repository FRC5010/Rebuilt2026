...
public abstract class CameraSystem extends GenericSubsystem
{
     ...
     *
     * <p>Initializes the camera subsystem and sets up telemetry displays for vision system status
    ...
    /**
     * Enables or disables the camera from viewing game pieces in simulation. When enabled, the
     * camera will simulate vision targets for game pieces in the arena. This can be useful for
     * testing vision code without a real camera. When disabled, the camera will only process vision
     ...
     *
     * <p>This method is called from {@link #periodic()} and is responsible for refreshing vision
     * data from the camera. Subclasses may override this to perform additional processing beyond
     * basic camera updates.
     *
     ...
     * specific type of target being tracked. The meaning of "distance" depends on the
     * implementation:
     *
     * <ul>
