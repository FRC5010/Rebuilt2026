...
public class AprilTagPoseSystem extends CameraSystem
{
    ...
    {
        return targetPose3ds.get(camera)
     ...
     * @return the distance to the target
     */
    @Override public double getDistanceToTarget()
    {
    ...
    public Vector<N3> getStdVector(double distance)
    {
        ...
        return VecBuilder.fill(calib, calib,
                               Units.degreesToRadians(stdVectorRadianFactor.getValue() * distance));
    }
