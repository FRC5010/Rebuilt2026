...
public class SwerveTractionControl extends GenericSubsystem
{
    ...
    public SwerveTractionControl(Supplier<SwerveModuleState[]> swerveModuleStatesSupplier,
    ...
    public double[] getWheelSlip()
    {
        ...
        {
            wheelSlips[i] = calculateSlippage(swerveModuleStates[i].speedMetersPerSecond,
