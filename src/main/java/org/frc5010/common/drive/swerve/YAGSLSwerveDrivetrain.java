...
public class YAGSLSwerveDrivetrain extends SwerveDriveFunctions
{
    ...
    public YAGSLSwerveDrivetrain(GenericDrivetrainConstants constants,
    ...
    @Override public Command sysIdDriveMotorCommand(SubsystemBase swerveSubsystem)
    {
        return SwerveDriveTest.generateSysIdCommand(
            SwerveDriveTest.setDriveSysIdRoutine(
                ...
                swerveSubsystem, swerveDrive, 12, true),
            3.0, 10.0, 4.0);
    }
    ...
    {
        return SwerveDriveTest.generateSysIdCommand(
            SwerveDriveTest.setAngleSysIdRoutine(new Config(), swerveSubsystem, swerveDrive), 3.0,
            3.0, 1.0);
    }
     ...
     * @return Drive command.
     */
    public Command simDriveCommand(DoubleSupplier translationX,
                                   DoubleSupplier translationY,
                                   DoubleSupplier rotation)
    {
        ...
        return run(() -> {
            ...
            driveFieldOriented(swerveDrive.swerveController.getTargetSpeeds(
                ...
                rotation.getAsDouble() * Math.PI, swerveDrive.getOdometryHeading().getRadians(),
                swerveDrive.getMaximumChassisVelocity()));
        });
    }
    ...
    {
        swerveDrive.drive(
            translation, rotation, fieldRelative,
    ...
    {
        swerveDrive.drive(velocity, swerveDrive.kinematics.toSwerveModuleStates(velocity),
     ...
     */
    @Override public void setPose(Pose2d initialHolonomicPose)
    {
     ...
     * measurements from vision less. This matrix is in the form [x, y, theta]^T, with units in
     * meters and radians.
     */
    @Override
     ...
     * simulation.
     *
     * @return A supplier of the current simulated drivetrain, or an empty optional if not running
     *     in simulation.
     */
    @Override
    ...
    {
        return ()
                   -> swerveDrive.getMapleSimDrive().map(
                       obj
                       -> (AbstractDriveTrainSimulation) (Object) swerveDrive.getMapleSimDrive()
                              .orElse(null));
    }
}
