...
public class Module
{
            ...
            constants)
    {
        ...
        turnEncoderDisconnectedAlert =
            new Alert("Disconnected turn encoder on module " + Integer.toString(index) + ".",
                      AlertType.kError);
    }
    ...
    public void periodic()
    {
        ...
        int sampleCount =
            Math.min(inputs.odometryDrivePositionsRad.length,
    ...
    public void runCharacterization(double output, AkitSwerveConfig config)
    {
        ...
        io.setTurnPosition(new Rotation2d(config.getModuleConstants(index).LocationX,
