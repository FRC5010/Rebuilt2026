...
public class AkitSwerveConfig extends SwerveDriveConfig
{
    ...
    public AkitSwerveConfig(AkitTalonFXSwerveConfigBuilder builder)
    {
        ...
        DRIVE_BASE_RADIUS =
            Math.max(Math.max(Math.hypot(FrontLeft.LocationX, FrontLeft.LocationY),
                              Math.hypot(FrontRight.LocationX, FrontRight.LocationY)),
                     Math.max(Math.hypot(BackLeft.LocationX, BackLeft.LocationY),
    ...
    public static AkitSwerveConfig builder(DrivetrainConstantsJson constants,
        ...
        extends SwerveDriveConfig.SwerveDriveConfigBuilder
    {
        ...
        private final SwerveModuleConstantsFactory<TalonFXConfiguration,
        ...
        public AkitTalonFXSwerveConfigBuilder(DrivetrainConstantsJson constants,
                                              SubsystemBase subsystem)
        {
            super();
            ...
            driveGearRatio = new MechanismGearing(GearBox.fromStages(constants.driveGearRatio))
                                 .getRotorToMechanismRatio();
            steerGearRatio = new MechanismGearing(GearBox.fromStages(constants.steerGearRatio))
                                 .getRotorToMechanismRatio();
            ...
            ConstantCreator =
                new SwerveModuleConstantsFactory<TalonFXConfiguration, TalonFXConfiguration,
                    ...
                    .withSteerMotorInitialConfigs(new TalonFXConfiguration().withCurrentLimits(
            ...
            FrontLeft               = ConstantCreator.createModuleConstants(
                ...
                kFrontLeftXPos, kFrontLeftYPos, constants.invertLeftSide,
            ...
            FrontRight               = ConstantCreator.createModuleConstants(
                ...
                kFrontRightXPos, kFrontRightYPos, constants.invertRightSide,
            ...
            BackLeft               = ConstantCreator.createModuleConstants(
                ...
                kBackLeftXPos, kBackLeftYPos, constants.invertLeftSide,
            ...
            BackRight               = ConstantCreator.createModuleConstants(
                ...
                kBackRightXPos, kBackRightYPos, constants.invertRightSide,
