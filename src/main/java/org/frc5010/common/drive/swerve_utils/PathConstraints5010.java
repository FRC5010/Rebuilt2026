 ...
 */
public record PathConstraints5010(double maxVelocityMPS,
                                  ...
                                  boolean unlimited)
{
    ...
    public PathConstraints5010(
        LinearVelocity maxVelocity, LinearAcceleration maxPhysicalAcceleration,
        ...
        Supplier<LinearVelocity> maxForwardVelocity, Supplier<LinearVelocity> maxBackwardVelocity,
        Supplier<LinearVelocity> maxLeftVelocity, Supplier<LinearVelocity> maxRightVelocity,
        AngularVelocity maxAngularVelocity, AngularAcceleration maxAngularAcceleration,
        Voltage nominalVoltage, boolean unlimited)
    {
        this(maxVelocity.in(MetersPerSecond), maxPhysicalAcceleration, maxForwardAcceleration,
             maxBackwardAcceleration, maxLeftAcceleration, maxRightAcceleration, maxForwardVelocity,
             maxBackwardVelocity, maxLeftVelocity, maxRightVelocity,
             maxAngularVelocity.in(RadiansPerSecond),
             maxAngularAcceleration.in(RadiansPerSecondPerSecond), nominalVoltage.in(Volts),
             unlimited);
    }
