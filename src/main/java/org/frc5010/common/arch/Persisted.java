 ...
 *       <ul>
 *         <li><code>
 *             private static Persisted&lt;Integer&gt; varName = new
 * Persisted&lt;&gt;(Constants.varName, 60);
 *             </code>
 *       </ul>
 ...
 *         <li><code>
 *             private static Persisted&lt;Integer&gt; varName = new
 * Persisted&lt;&gt;(Constants.varName, Integer.class);
 *             </code>
 *       </ul>
...
public class Persisted<T> extends GenericPersisted
{
    ...
    /**
     * Persisted constructor used when only retrieving values in additional classes The type needs
     * to be specified like: Integer.class
     *
     * @param name Ex: <code>static final String variableName = "variableName";</code>
     ...
     */
    @SuppressWarnings("unchecked") private T initGet()
    {
        switch (getType())
        {
            case "Double":
