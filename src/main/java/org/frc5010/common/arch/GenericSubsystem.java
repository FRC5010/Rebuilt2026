...
public class GenericSubsystem
    extends SubsystemBase implements WpiHelperInterface, GenericDeviceHandler
{
     ...
     */
    @Override public void addDevice(String name, Object device)
    {
    ...
    /**
     * Called every time the scheduler runs while the robot is enabled. Used to update display
     * values and draw motor graphics.
     */
    @Override public void periodic()
    {
        DashBoard.notifyListeners();
        devices.values().stream().forEach(it -> {
