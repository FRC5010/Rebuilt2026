...
public abstract class GenericRobot extends GenericMechanism implements GenericDeviceHandler
{
            ...
            Commands
                .run(() -> {
                    ...
                    LEDStrip.changeSegmentPattern(ConfigConstants.ALL_LEDS,
                                                  LEDStrip.getSolidPattern(allianceWpiColor));
                })
    ...
    @Override protected void initRealOrSim()
    {
        if (RobotBase.isReal())
        {
    ...
    /**
     * Sets up the default commands for the robot. If the robot is in teleoperated or autonomous
     * mode, it will call the setupDefaultCommands method. If the robot is in test mode, it will
     * call the setupTestDefaultCommands method.
     */
    ...
    public String determineAlliance()
    {
        ...
        allianceWpiColor = color
                               .map(it
                                    -> it == Alliance.Red ? edu.wpi.first.wpilibj.util.Color.kRed
    ...
    public static edu.wpi.first.wpilibj.util.Color chooseAllianceWpiColor()
    {
        ...
        if (allianceColor.isPresent())
        {
            return allianceColor.get() == Alliance.Red ? edu.wpi.first.wpilibj.util.Color.kRed
                                                       : edu.wpi.first.wpilibj.util.Color.kBlue;
        }
     ...
     */
    @Override public void addDevice(String name, Object mechanism)
    {
     ...
     */
    @Override public Object getDevice(String name)
    {
     ...
     */
    @Override public DisplayValuesHelper getDisplayValuesHelper()
    {
        return DashBoard;
    }
}
