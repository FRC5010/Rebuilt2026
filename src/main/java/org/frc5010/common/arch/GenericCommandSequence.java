...
public class GenericCommandSequence extends Command implements WpiHelperInterface
{
     ...
     */
    @SuppressWarnings("this-escape") public GenericCommandSequence(String log, Command... commands)
    {
        this.logPrefix = log;
     ...
     */
    @SuppressWarnings("PMD.UseArraysAsList") public final void addCommands(Command... commands)
    {
    ...
    @Override public final void initialize()
    {
        ...
        if (!m_commands.isEmpty())
        {
            ...
            logCurrentAction(": Running command " + m_commands.get(m_currentCommandIndex).getName()
                             + " : " + m_currentCommandIndex + " of " + m_commands.size());
        }
    }
    ...
    @Override public void execute()
    {
        ...
        if (currentCommand.isFinished())
        {
            ...
            {
                logCurrentAction(": Running command "
