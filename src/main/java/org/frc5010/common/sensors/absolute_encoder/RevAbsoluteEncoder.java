...
public class RevAbsoluteEncoder extends GenericAbsoluteEncoder
{
    ...
    public RevAbsoluteEncoder(SparkMax motor, int conversionFactor)
    {
        ...
        failureConfiguring = new Alert("Encoders", "Failure configuring SparkMax Analog Encoder",
                                       Alert.AlertType.kWarning);
        offsetFailure      = new Alert("Encoders", "Failure to set Absolute Encoder Offset",
                                  Alert.AlertType.kWarning);
        ...
        else
        {
            throw new RuntimeException(
                "Motor given to instantiate SparkMaxEncoder is not a SparkMax");
        }
    }
    ...
    @Override public void factoryDefault()
    {
        // Do nothing
    }
     ...
     */
    @Override public void configure(boolean inverted)
    {
     ...
     */
    @Override public Object getEncoder()
    {
        return encoder;
    }
     ...
     */
    @Override public boolean setEncoderOffset(double offset)
    {
