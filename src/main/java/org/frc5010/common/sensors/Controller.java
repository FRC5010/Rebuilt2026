...
public class Controller
{
    ...
    public JoystickButton A_BUTTON, B_BUTTON, X_BUTTON, Y_BUTTON, LEFT_BUMPER, RIGHT_BUMPER,
        START_BUTTON, BACK_BUTTON, LEFT_STICK_BUTT, RIGHT_STICK_BUTT;
    private POVButton UP, RIGHT, DOWN, LEFT;
    private Map<Integer, Axis> axisMap = new HashMap<>(Map.of(AxisNums.LEFT_X.ordinal(),
                                                              new Axis(),
                                                              AxisNums.LEFT_Y.ordinal(),
                                                              new Axis(),
                                                              AxisNums.L_TRIGGER.ordinal(),
                                                              new Axis(),
                                                              AxisNums.R_TRIGGER.ordinal(),
                                                              new Axis(),
                                                              AxisNums.RIGHT_X.ordinal(),
                                                              new Axis(),
                                                              AxisNums.RIGHT_Y.ordinal(),
                                                              new Axis()));

    private static enum AxisNums { LEFT_X, LEFT_Y, L_TRIGGER, R_TRIGGER, RIGHT_X, RIGHT_Y }
