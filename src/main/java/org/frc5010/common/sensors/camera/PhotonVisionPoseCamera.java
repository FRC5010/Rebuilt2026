...
public class PhotonVisionPoseCamera extends PhotonVisionCamera implements FiducialTargetCamera
{
     ...
     */
    public PhotonVisionPoseCamera(String name,
                                  int colIndex,
                                  ...
                                  List<Integer> fiducialIds)
    {
        ...
        AprilTagFieldLayout filteredLayout = new AprilTagFieldLayout(
    ...
    @Override public void updateCameraInfo()
    {
        ...
        for (PhotonPipelineResult iCamResult : camResults)
        {
            ...
            if (estimate.isPresent())
            {
                ...
                SmartDashboard.putNumber("Camera/" + name() + "/Total Distance To Tag " + name,
                                         totalTagDistance);
                SmartDashboard.putNumber("Camera/" + name() + "/Photon Ambiguity " + name,
                ...
                observations.add(new PoseObservation(
                    ...
                    // 3D pose estimate
                    robotPose, iCamResult.getBestTarget().poseAmbiguity, tagCount, averageDistance,
    ...
    @Override public Matrix<N3, N1> getStdDeviations(PoseObservation observation)
    {
        ...
        if ((observation.averageTagDistance() > 2.5 && RobotState.isEnabled()
