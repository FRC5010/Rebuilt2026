...
public class DisplayDouble extends DisplayableValue
{
     ...
     */
    public DisplayDouble(final double defaultValue,
                         final String name,
                         final String table,
        ...
        if (LogLevel.CONFIG == logLevel)
        {
            ...
            if (DisplayValuesHelper.isAtLogLevel(LogLevel.CONFIG))
            {
                ...
                listenerHandle_ = NetworkTableInstance.getDefault().addListener(
                    ...
                    event -> { setValue(event.valueData.value.getDouble(), false); });
    ...
    /**
     * Registers a listener to the display values helper to update this double with the result of
