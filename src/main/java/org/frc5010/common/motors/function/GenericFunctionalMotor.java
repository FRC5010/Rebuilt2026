...
public class GenericFunctionalMotor implements GenericMotorController, WpiHelperInterface
{
    ...
    protected Alert loggingAlert =
        new Alert(this.getClass().getSimpleName() + " Logging Mode is not COMPETITION!",
                  AlertType.kWarning);
     ...
     */
    @Override public void setInverted(boolean isInverted)
    {
    ...
    /**
     * Converts a given distance in the x-direction to a x-coordinate appropriate for visualizing on
     * a LoggedMechanism2d.
     *
    ...
    /**
     * Converts a given distance in the y-direction to a y-coordinate appropriate for visualizing on
     * a LoggedMechanism2d.
     *
    ...
    /**
     * Get the applied output of the motor controller. This is the output as a value from -1 to 1
     * that is actually being applied to the motor.
     *
    ...
    /**
     * Sets the DisplayValuesHelper that this motor will use to display information on the
     * dashboard. If this is not set, the motor will not be visible on the dashboard.
     *
     ...
     * simulation type to the motor controller, which should be implemented to use the simulated
     * motor type in its simulation.
     *
