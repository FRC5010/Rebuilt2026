...
public class RioPIDController extends GenericPIDControllerAbsract
{
    ...
    @Override public void setReference(double reference)
    {
        executeSwitchedTask(()
                            ...
                            () -> profiledPIDController.setGoal(reference));
    }
    ...
    {
        profiledPIDController.setConstraints(new TrapezoidProfile.Constraints(
    ...
    {
        return executeSwitchedGetter(
            () -> pidController.getP(), () -> profiledPIDController.getP());
    }

    @Override public double getI()
    {
        return executeSwitchedGetter(
            () -> pidController.getI(), () -> profiledPIDController.getI());
    }

    @Override public double getD()
    {
        return executeSwitchedGetter(
            () -> pidController.getD(), () -> profiledPIDController.getD());
    }
