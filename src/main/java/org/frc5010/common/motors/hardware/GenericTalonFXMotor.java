...
public class GenericTalonFXMotor implements GenericMotorController
{
     ...
     */
    @Override public GenericMotorController duplicate(int port)
    {
    ...
    @Override public void factoryDefaults()
    {
     ...
     */
    @Override public GenericMotorController setCurrentLimit(Current limit)
    {
    ...
    private void refreshCurrentLimits()
    {
        ...
        cfg.apply(configuration.CurrentLimits.withSupplyCurrentLimit(supplyCurrentLimit)
     ...
     * @return a reference to the current MotorController5010 instance
     */
    @Override public GenericMotorController setSlewRate(double rate)
    {
     ...
     * @return a reference to the current MotorController5010 instance
     */
    @Override public GenericMotorController setFollow(GenericMotorController motor)
    {
    ...
    {
        this.motor.setControl(
            new Follower(((TalonFX) motor.getMotor()).getDeviceID(),
    ...
    @Override public void setInverted(boolean inverted)
    {
        ...
        configuration.MotorOutput.withInverted(!inverted ? InvertedValue.CounterClockwise_Positive
     ...
     * @return a reference to the current MotorController5010 instance
     */
    @Override public GenericMotorController invert(boolean inverted)
    {
     ...
     *     motor.
     */
    @Override public GenericEncoder getMotorEncoder()
    {
        return encoder;
    }
     ...
     *     motor.
     */
    @Override public GenericEncoder createMotorEncoder(int countsPerRev)
    {
     ...
     *
     * @return an instance of PIDController5010, specifically a TalonFXPID associated with this
     *     motor.
     */
    @Override public GenericPIDController getPIDController5010()
    {
        return controller;
    }
     ...
     */
    @Override public Object getMotor()
    {
        return motor;
    }
     ...
     */
    @Override public SysIdRoutine getDefaultSysId(SubsystemBase subsystemBase)
    {
    ...
    /**
     * Returns the type of motor that is being simulated. This is used for motor system
     * identification and simulation.
     *
     * @return The type of motor being simulated.
     */
    @Override public DCMotor getMotorSimulationType()
    {
        return motorSim;
    }
     ...
     */
    @Override public AngularVelocity getMaxRPM()
    {
     ...
     *
     * <p>This method does not do anything for TalonFX motors, but is included to provide a
     * consistent interface with other motor types.
     *
     * @param nominalVoltage The nominal voltage to set for voltage compensation.
     * @return This motor controller.
     */
    @Override public GenericMotorController setVoltageCompensation(double nominalVoltage)
    {
        return this;
    }
     ...
     */
    @Override public GenericMotorController setMotorBrake(boolean isBrakeMode)
    {
     ...
     * restarted.
     */
    @Override public void burnFlash()
    {
        cfg.apply(configuration);
    }
     ...
     *
     * <p>This method waits for the voltage update within a specified timeout and returns the
     * motor's voltage in volts.
     *
     ...
     */
    @Override public void set(double percentOutput)
    {
     ...
     *
     * <p>This method checks the current motor output configuration and determines if the motor is
     * set to be inverted.
     *
    ...
    @Override public void stopMotor()
    {
        motor.stopMotor();
    }
     ...
     */
    @Override public void setMotorSimulationType(DCMotor motorSimulationType)
    {
     ...
     */
    @Override public void setMaxRPM(AngularVelocity rpm)
    {
        maxRPM = rpm;
    }
     ...
     */
    @Override public Motor getMotorConfig()
    {
        return config;
    }

    @Override public SmartMotorController getSmartMotorController(SmartMotorControllerConfig config)
    {
