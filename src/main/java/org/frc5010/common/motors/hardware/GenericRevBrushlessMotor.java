...
public class GenericRevBrushlessMotor implements GenericMotorController
{
    ...
    public void updateConfig(SparkMaxConfig cfgGiven)
    {
        cfg.apply(cfgGiven);
        configureSparkMax(()
                              -> motor.configure(cfg, ResetMode.kNoResetSafeParameters,
     ...
     */
    @Override public GenericMotorController setCurrentLimit(Current currentLimit)
    {
     ...
     *
     * @return a new instance of GenericEncoder, which wraps the encoder returned by the
     *     superclass's getEncoder() method
     */
    ...
    {
        return SystemIdentification.rpmSysIdRoutine(this, getMotorEncoder(),
                                                    "Motor " + motor.getDeviceId(), subsystemBase);
    }
