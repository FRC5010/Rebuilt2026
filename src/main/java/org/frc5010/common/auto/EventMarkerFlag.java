...
public class EventMarkerFlag extends GenericCommand
{
    ...
    /**
     * On the creation of the marker, called by markers created on autonomous pathes, set the state
     * to true
     */
    ...
    /**
     * On the end of the marker command, called by markers created on autonomous pathes, set the
     * state to false
     */
    ...
    /**
     * Constructs a trigger that is active when the marker is active and binds it to a specific
     * event loop
     *
     * @param name The name of the marker to create a trigger for
