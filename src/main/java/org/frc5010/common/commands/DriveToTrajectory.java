...
{
    public static enum LCR { left, center, right }
    ...
    public DriveToTrajectory(GenericSwerveDrivetrain swerveDrivetrain,
    ...
    @Override public void execute()
    {
        ...
        //  this.swerveDrivetrain.drive(this.driveController.calculate(currentPose,
        //  currentSetpoint));
    }
