...
public class DefaultDriveCommand extends Command
{
                               ...
                               Supplier<Boolean> fieldOrientedDrive)
    {
        ...
        heading =
            new LoggedMechanismLigament2d("heading", 20, 0, 6, new Color8Bit(Color.kDeepPink));
    ...
    @Override public void execute()
    {
        ...
        if (fieldOrientedDrive.get())
        {
            ChassisSpeeds chassisSpeeds = ChassisSpeeds.fromFieldRelativeSpeeds(
                x * maxChassisVelocity.get(), y * maxChassisVelocity.get(),
                r * maxChassisRotation.get(), drivetrainSubsystem.getHeading());
            drivetrainSubsystem.drive(chassisSpeeds);
        }
        else
        {
            drivetrainSubsystem.drive(new ChassisSpeeds(x * maxChassisVelocity.get(),
