...
public class AkitDriveCommands
{
     ...
     */
    public static Command joystickDrive(GenericSwerveDrivetrain swerveDrive,
                                        ...
                                        DoubleSupplier omegaSupplier)
    {
        return Commands.run(() -> {
            ...
            drive.runVelocity(ChassisSpeeds.fromFieldRelativeSpeeds(
                speeds, isFlipped ? drive.getRotation().plus(new Rotation2d(Math.PI))
                                  : drive.getRotation()));
        }, swerveDrive);
    }
     ...
     */
    public static Command joystickDriveAtAngle(GenericSwerveDrivetrain swerveDrive,
                                               AkitSwerveDrive drive,
                                               DoubleSupplier xSupplier,
                                               DoubleSupplier ySupplier,
     ...
     */
    public static Command feedforwardCharacterization(GenericSubsystem subsystem,
                                                      ...
                                                      Supplier<Double> velocitySupplier)
    {
        ...
        return Commands.sequence(
            ...
            Commands.run(() -> { characterizer.accept(Volts.of(0.0)); }, subsystem)
     ...
     */
    public static Command wheelRadiusCharacterization(GenericSwerveDrivetrain swerveDrive,
                                                      AkitSwerveDrive drive)
    {
                ...
                Commands
                    ...
                    .finallyDo(() -> {
                        ...
                        System.out.println("\tWheel Delta: " + formatter.format(wheelDelta)
                                           + " radians");
                        System.out.println("\tGyro Delta: " + formatter.format(state.gyroDelta)
                                           + " radians");
                        System.out.println(
     ...
     * @param drive the swerve drive implementation
     * @return a command that measures velocity errors across multiple setpoints and logs suggested
     *     kP values
     */
    public static Command drivePIDTuning(GenericSwerveDrivetrain swerveDrive, AkitSwerveDrive drive)
    {
        final double[] TARGET_VELOCITIES = {0.5, 1.0, 1.5,
                                            2.0, 2.5, 3.0}; // Range of velocities in m/s
        ...
        return Commands.sequence(
                             ...
                             Commands
                                 .run(
                                     ()
                                         ...
                                         for (int i = 0; i < 4; i++)
                                         {
                                             avgVelocity += drive.getModulesInfo()[i]
            ...
            Commands.runOnce(() -> {
                ...
                System.out.println("\tTarget Velocities: "
                                   + java.util.Arrays.toString(TARGET_VELOCITIES) + " m/s");
                System.out.println("\tNumber of Samples: " + allVelocityErrors.size());
                System.out.println("\tAverage Velocity Error: " + formatter.format(avgError)
                                   + " m/s");
                ...
                SmartDashboard.putNumber("Characterization/Drive/Sample_Count",
                                         allVelocityErrors.size());
            }));
    }
     ...
     *
     * <p>This command applies a range of target angle setpoints to the steer motors and measures
     * the resulting angle errors to calculate a more robust P value for closed-loop control.
     *
     * <p>The P value is calculated using: kP = Applied Voltage / Average Angle Error across
     * multiple setpoints
     *
     * @param swerveDrive the swerve drivetrain subsystem to tune
     * @param drive the swerve drive implementation
    ...
    {
        final double[] TARGET_ANGLES = {15.0, 30.0, 45.0,
                                        60.0, 75.0, 90.0}; // Range of angles in degrees
        ...
        return Commands.sequence(
            ...
            Commands.runOnce(() -> {
                ...
                System.out.println("\tTarget Angles: " + java.util.Arrays.toString(TARGET_ANGLES)
                                   + " degrees");
                System.out.println("\tNumber of Samples: " + allAngleErrors.size());
                System.out.println("\tAverage Angle Error: "
                                   + formatter.format(Math.toDegrees(avgError)) + " degrees");
                System.out.println("\tSuggested kP: " + formatter.format(kP));
                System.out.println("*******************************************************");
                SmartDashboard.putNumber("Characterization/Steer/P_Value", kP);
                SmartDashboard.putNumber("Characterization/Steer/Avg_Angle_Error",
                                         Math.toDegrees(avgError));
                SmartDashboard.putNumber("Characterization/Steer/Sample_Count",
                                         allAngleErrors.size());
            }));
    }
}
