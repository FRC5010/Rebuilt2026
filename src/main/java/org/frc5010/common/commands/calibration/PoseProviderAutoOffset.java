...
public class PoseProviderAutoOffset
{
    ...
    public static Command createPoseProviderAutoOffset(Supplier<Pose2d> rawPoseSupplier,
    ...
    public static void execute()
    {
        ...
        SmartDashboard.putNumberArray(name + " Camera Calculated Offset to Robot Center",
