...
public class DriveToPosition extends GenericCommand
{
     ...
     */
    public DriveToPosition(GenericSwerveDrivetrain swerveSubsystem,
                           ...
                           Transform2d offset)
    {
        ...
        thetaConstraints = new TrapezoidProfile.Constraints(
            ...
            swerveSubsystem.getSwerveConstants()
                .getkTeleDriveMaxAngularAccelerationUnitsPerSecond());

        xController     = new ProfiledPIDController(pidTranslation.getkP(), pidTranslation.getkI(),
                                                pidTranslation.getkD(), xConstraints);
        yController     = new ProfiledPIDController(pidTranslation.getkP(), pidTranslation.getkI(),
                                                pidTranslation.getkD(), yConstraints);
    ...
    @Override public void execute()
    {
        ...
        double distanceToGoal =
            robotPose2d.getTranslation().getDistance(targetPose.getTranslation());
