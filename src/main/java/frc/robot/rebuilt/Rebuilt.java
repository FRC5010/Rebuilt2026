...
public class Rebuilt extends GenericRobot
{
    ...
    public void configureButtonBindings(Controller driver, Controller operator)
    {
        if (!isButtonsConfigured)
        {
            ...
            driver.createYButton().onTrue(
                Commands.runOnce(() -> drivetrain.toggleFieldOrientedDrive()));
    ...
    @Override public void configureAltButtonBindings(Controller driver, Controller operator)
    {
