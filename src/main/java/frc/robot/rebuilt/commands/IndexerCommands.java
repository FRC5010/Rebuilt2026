...
public class IndexerCommands
{
    ...
    public static enum IndexerState { IDLE, CHURN, HARD_CHURN, FORCE, FEED }
    ...
    private void configureTriggerStates()
    {
        ...
        java.util.Map<IndexerState, Command> stateToCommand =
            java.util.Map.of(IndexerState.FEED, feedStateCommand(), IndexerState.FORCE,
                             forceStateCommand(), IndexerState.IDLE, idleStateCommand(),
