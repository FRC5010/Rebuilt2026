...
{
    private enum CalibrationState { ALIGN_AND_DRIVE, TUNE_AND_FIRE, NEXT_DISTANCE }
    ...
    public ShotCalibrationCommand(Launcher launcher,
                                  ...
                                  double distanceStep)
    {
        ...
        xController =
            new ProfiledPIDController(2.0, 0, 0, new TrapezoidProfile.Constraints(0.2, 0.5));
        yController =
            new ProfiledPIDController(2.0, 0, 0, new TrapezoidProfile.Constraints(0.2, 0.5));
    ...
    private void handleAlignAndDrive()
    {
        ...
        Translation2d targetTranslation =
            hubTarget.plus(new Translation2d(currentDistanceMeters, 0.0));
    ...
    private void handleTuneAndFire()
    {
        ...
        // 4. Handle "Force Firing" integration -> we can't fully control the indexer natively
        // inside a standard command without parallel racing, so we assume the operator maps a
        // secondary button to IndexerCommands.shouldFeedCommand() to actually shoot the pre-spun
        // ball. The "Force Firing" boolean here is mostly visual if they prefer button boards.
        ...
        if (nextRequested)
        {
            ...
            shotCalculator.addDataPoint(getActualDistance(), hoodSetpoint, rpmSetpoint,
                                        getActualDistance() / 15.0);
                                         ...
                                         double distanceStep)
    {
        return Commands.parallel(
            ...
            Commands.either(IndexerCommands.shouldForceCommand(),
