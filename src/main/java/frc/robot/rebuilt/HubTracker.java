...
public class HubTracker
{
    ...
    /**
     * Returns an {@link Optional} containing the current {@link Time} remaining in the current
     * shift. Will return {@link Optional#empty()} if disabled or in between auto and teleop.
     */
    ...
    public static boolean isActive()
    {
        Optional<Shift> currentShift = getCurrentShift();
        Optional<Alliance> alliance  = DriverStation.getAlliance();
        return currentShift.isPresent() && alliance.isPresent()
    ...
    public static boolean isActiveNext()
    {
        Optional<Shift> nextShift   = getNextShift();
        Optional<Alliance> alliance = DriverStation.getAlliance();
        return nextShift.isPresent() && alliance.isPresent()
    ...
    private enum ActiveType { BOTH, AUTO_WINNER, AUTO_LOSER }
}
