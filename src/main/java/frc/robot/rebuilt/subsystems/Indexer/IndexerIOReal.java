...
public class IndexerIOReal implements IndexerIO
{
    ...
    @Override public void updateInputs(IndexerIOInputs inputs)
    {
    ...
    @Override public void runSpindexer(double speed)
    {
        spindexer.set(speed);
    }
    /** Sets the front transfer motor speed */
    @Override public void runTransferFront(double speed)
    {
