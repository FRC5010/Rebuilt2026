...
public interface LauncherIO {
    @AutoLog public static class LauncherIOInputs
    {
        ...
        /**
         * Intializes the distance to the virtual target and desired flywheel speed to start at 0
         * and calculation validity to false
         */
        ...
        /**
         * Intializes calculated and desired angles to 0 degrees and calculated flywheel speed to 0
         * RPS
         */
        ...
        /**
         * Initializes actual flywheel speed to 0 RPM and actual hood and turret angles to 0
         * degrees
         */
