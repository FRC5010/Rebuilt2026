...
public class FieldRegions
{
    ...
    static double lowerTrenchRightX =
        FieldConstants.TrenchZoneBottom.nearAllianceRightDanger.getX();
    static double lowerTrenchY = FieldConstants.TrenchZoneBottom.oppAllianceLeftDanger.getY();

    static double lowerOppTrenchLeftX =
        FieldConstants.TrenchZoneBottom.oppAllianceLeftDanger.getX();
    ...
    static Translation2d AllianceCornerTrench =
        new Translation2d(FieldConstants.TrenchZoneBottom.nearAlliance.getX()
                              - 1 / 2 * FieldConstants.LeftTrench.depth,
                          FieldConstants.fieldWidth);
    static Translation2d topRightMidTrenchCorner = new Translation2d(
        FieldConstants.TrenchZoneTop.oppAlliance.getX() - 1 / 2 * FieldConstants.RightTrench.depth,
        FieldConstants.fieldWidth);
    static Translation2d bottomRightMidTrenchCorner = new Translation2d(
    ...
    public static void setupFieldRegions()
    {
        ...
        topTrenchY =
            AllianceFlipUtil.apply(FieldConstants.TrenchZoneTop.nearAllianceLeftDanger).getY();
        topOppTrenchLeftX =
        ...
        AllianceCornerTrench = AllianceFlipUtil.apply(
            new Translation2d(FieldConstants.TrenchZoneBottom.nearAlliance.getX()
                                  - 1 / 2 * FieldConstants.LeftTrench.depth,
                              FieldConstants.fieldWidth));
        topRightMidTrenchCorner =
            AllianceFlipUtil.apply(new Translation2d(FieldConstants.TrenchZoneTop.oppAlliance.getX()
        ...
        bottomRightMidTrenchCorner =
            AllianceFlipUtil.apply(new Translation2d(FieldConstants.TrenchZoneTop.oppAlliance.getX()
                                                         - 1 / 2 * FieldConstants.LeftTrench.depth,
                                                     0));
        oppTopRightOrigin = AllianceFlipUtil.apply(
            new Translation2d(FieldConstants.fieldLength, FieldConstants.fieldWidth));
        oppBottemRightOrigin =
            AllianceFlipUtil.apply(new Translation2d(FieldConstants.fieldLength, 0));
    ...
    public static boolean isNearTrench(double currentX, double currentY)
    {
        ...
        boolean nearOppAllianceTop =
            ((currentX > topOppTrenchLeftX && currentX < topOppTrenchRightX)
             && currentY > topTrenchY);

        boolean nearAllianceBottom = ((currentX > lowerTrenchLeftX && currentX < lowerTrenchRightX)
